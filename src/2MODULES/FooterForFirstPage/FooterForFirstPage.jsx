        ...
        <footer className={cl.footerWrapper}>
            ...
            <div className={cl.authors}>
                <h4 className={cl.author}>
                    Максим 
                    <a rel="noreferrer" href="https://github.com/kasdfsfen" target="_blank"><img src={github} alt="github" className={cl.iconImg}/></a>
                    <a rel="noreferrer" href="/" target="_blank"><img src={telegram} alt="telegram" className={cl.iconImg}/></a>
                    <a rel="noreferrer" href="https://vk.com/id547351603" target="_blank"><img src={vk} alt="vk" className={cl.iconImg}/></a>
                </h4>
                <h4 className={cl.author}>
                    Александр
                    <a rel="noreferrer" href="https://github.com/zxcPAPASHAzxc" target="_blank"><img src={github} alt="github" className={cl.iconImg}/></a>
                    <a rel="noreferrer" href="/" target="_blank"><img src={telegram} alt="telegram" className={cl.iconImg}/></a>
                    <a rel="noreferrer" href="/" target="_blank"><img src={vk} alt="vk" className={cl.iconImg}/></a>
                </h4>
            </div>
